...
This function is used inside `ξ_GNCxLD_Newtonian_Lensing` with the trapz() from the 
...
It's computed through the symmetric function `ξ_GNCxLD_Newtonian_Lensing`; check its documentation for
...
[`ξ_GNCxLD_Newtonian_Lensing`](@ref)
"""
